...
public class ClsDaoImpl implements ClsDao {
	...
	/**
	 * Selects all records from the Cls table and returns them
	 * as a list of Cls objects
	 */
	@Override
	...
	/**
	 * Takes in an Integer object whose value corresponds to the primary key
	 * of a record in the Cls table and returns that record as a Cls object
	 */
	@Override
	...
	/**
	 * Takes in a Cls object and inserts a record into the Cls
	 * table that corresponds to that object. Returns the primary key of
	 * that record as an Integer object
	 */
	@Override
	...
	/**
	 * Takes in an Integer object whose value corresponds to the primary key
	 * of a record in the Cls table, and deletes that record from the table
	 */
	@Override
	 ...
	 * table to match it. Returns a new Cls object that represents the updated record
	 */
	@Override

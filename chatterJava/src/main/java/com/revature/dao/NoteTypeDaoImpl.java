...
public class NoteTypeDaoImpl implements NoteTypeDao {
	...
	/**
	 * Takes in an Integer and returns the record from the 
	 * NoteType table with that Integer value as its primary key as a
	 * NoteType object
	 */
	@Override
	...
	/**
	 * Takes in a NoteType object and updates the corresponding record
	 * in the NoteType table so that it's data matches the fields of the object.
	 * Returns a new NoteType object that corresponds to the updated record
	 */
	@Override
	...
	/**
	 * Takes in an Integer and deletes the record from the NoteType
	 * table with that value as its id
	 */
	@Override
	...
	/**
	 * Takes in a NoteType object and inserts a record into the NoteType
	 * table that corresponds to that object. Returns the primary key of 
